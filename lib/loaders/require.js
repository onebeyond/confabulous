...
var debug = require('debug')('confusion:loaders:require')
...
module.exports = function(_options) {
    ...
    return function(config, listener, cb) {
        debug('running')
        async.waterfall([validate, resolve, exists, unwatch, watch, clear, load], cb)
        ...
        function watch(target, cb) {
            ...
            if (options.watch) watcher = fs.watch(target, { persistent: false, encoding: options.encoding }, listener)
            return cb(null, target)
        }
